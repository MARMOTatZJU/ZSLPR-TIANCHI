...
# Team: AILAB-ZJU
# Code function：run training of ConvNet
# Author: Yinda XU
...
from models.ResNeXt_DenseNet import resnet50
from loss import loss_QFSL
...
# Model & Loss
model = resnet50(num_classes=NClassTotal).cuda()
...
lr_schduler = torch.optim.lr_scheduler.LambdaLR(
